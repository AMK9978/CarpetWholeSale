...
public class SoldReportsAdapter extends RecyclerView.Adapter<SoldReportsAdapter.Item> {

    private Context context;
    private ArrayList<Carpet> carpets;

    public SoldReportsAdapter(Context context, ArrayList<Carpet> carpets) {
